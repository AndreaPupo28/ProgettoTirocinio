...
if __name__ == "__main__":
    ...
    if not os.path.exists("/kaggle/working/modello_addestrato2.pth"):
        ...
        torch.save(model.state_dict(), "/kaggle/working/modello_addestrato2.pth")
        print("\nModello addestrato e salvato con successo.")
    else:
        print("\nCaricamento del modello già addestrato...")
        model.load_state_dict(torch.load("/kaggle/working/modello_addestrato2.pth"))
        model.eval()
